    ...
    <div className="flex flex-col lg:flex-row items-start justify-between">
      ...
      <div className="w-full lg:pt-[50px] lg:ml-[30px]">
        <h2 className="text-gradient text-[25px] mt-[10px]"
            ...
            data-aos-easing="ease-in-sine"
            data-aos-duration="800"
            data-aos-delay="800">I am Fadhilah Ardhiansyah, 22 years old, Bachelor's graduate in Information Systems from Universitas Bina Sarana Informatika, my religion is Islam, I am the first child of 2 siblings, I like the hobbies of pencak silat and music. Every day I practice pencak silat and play music. I am a person who has a strong determination to progress, disciplined, honest, agile, thorough, able to work together with teams and individuals. advantages: I can operate a computer, Install and configure Wireless LAN networks, Install and configure local network cables, install and configure internet networks, understand HTML, MySql, Tailwind CSS, PHP Frameworks Laravel, Github, Jira</p>
      </div>
    </div>
  </div>
</div>
